  ...
  Future<void> logout() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Erreur de déconnexion"), backgroundColor: Colors.red),
      );
    }
  }
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Image.asset(
                        ...
                        width: screenWidth * 0.4,  // Réduire la taille de l'image à 40% de la largeur de l'écran
                        height: screenWidth * 0.4, // Réduire la taille de l'image à 40% de la largeur de l'écran
                      ),
                    ),
                  ),
                  GestureDetector(
