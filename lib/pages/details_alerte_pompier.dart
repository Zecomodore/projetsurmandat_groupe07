  ...
  */
  ...
  void pompierDisponible() async {
    try {
      ...
      final response = await dio.post("/interventions/ajout/pompier",
        queryParameters: {
  ...
  void pompierEtat() async {
    try {
      ...
      final response = await dio.get("/interventions/etat/pompier",
        queryParameters: {
          'uti_use_id': PersonneVaraible().userId,
          'lsu_int_no': widget.idIntervention
        },
  ...
  void finIntervention() async {
    try {
      ...
      final response = await dio.delete("/interventions/supprimer/pompier",
        queryParameters: {
          'uti_use_id': PersonneVaraible().userId,
          'lsu_int_no': widget.idIntervention
        },
      ...
      print("Erreur: $e");
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("L'action à échoué"), backgroundColor: Colors.red),
      );
    }
  }
