...
/*
  ...
  */
  ...
  void finAlerte() async {
    ...
    final response = await dio.put("/interventions",
      queryParameters: {
    ...
    if (response.statusCode == 200) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("La fin de l'intervention à échoué"), backgroundColor: Colors.red),
      );
    }
  }
  ...
  void chargerPompierPresent() async {
    ...
    final response = await dio.get("/interventions/utilisateur/${widget.interventionId}");
    ...
    if (response.statusCode == 200) {
      ...
      print("Erreur: $e");
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Le chargement à échoué"), backgroundColor: Colors.red),
      );
    }
  }
  ...
  void chargerVehiculePresent() async {
    ...
    final response = await dio.get("/interventions/vehicule/${widget.interventionId}");
