...
class _MyLoginPage extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center( // Centre le contenu pour éviter le débordement
        child: SingleChildScrollView(
          child: Padding(
            padding: const EdgeInsets.all(16),
            child: Column(
              mainAxisSize: MainAxisSize.min, // Ajuste la taille pour éviter le débordement
              children: [
                SizedBox(
                ...
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    ...
                    minimumSize: Size(size.width * 0.7, 50), // Ajustement dynamique
                    elevation: 8,
                  ...
                  onPressed: () async {
                    ...
                    if(PersonneVaraible().token.isNotEmpty) {
                      print('Connexion réussie : ${PersonneVaraible().token} ${PersonneVaraible().nameType} ${PersonneVaraible().userId}'); 
